...
router.post('/bulk-upload', authenticate, authorize('admin'), upload.single('file'), userController.bulkUploadUsers);
...
router.get('/settings/admin', authenticate, authorize('admin'), userController.getAdminSettings);
router.put('/settings/admin', authenticate, authorize('admin'), userController.updateAdminSettings);
