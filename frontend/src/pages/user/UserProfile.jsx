          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">ID: {user?.user_id}</p>
                {user?.status === 'active' && (
              ...
              <button
                ...
                className="w-full mt-6 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center text-gray-700 dark:text-gray-300"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {profileErrors.room_number && (
                      <p className="mt-1 text-sm text-red-600">{profileErrors.room_number.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {profileErrors.hostel_block && (
                      <p className="mt-1 text-sm text-red-600">{profileErrors.hostel_block.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      <MdSchool className="inline w-4 h-4 mr-1" />
                      Year of Study
                    </label>
                    <select
                    ...
                    {profileErrors.year_of_study && (
                      <p className="mt-1 text-sm text-red-600">{profileErrors.year_of_study.message}</p>
                    )}
                  </div>
